...
workspace_name = "workspacedio" # PLACEHOLDER
subscription_id = "b7e79639-054f-4ee5-bb1d-4263f6efc170" # PLACEHOLDER
resource_group = "rg-dio-project-01" # PLACEHOLDER
experiment_name = "Exp-automl-projeto-01" # PLACEHOLDER
iteration = "20"  # PLACEHOLDER
run_id = "kind_boot_pjs8dddpzs_20"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/Exp-automl-projeto-01','subscription_id':'b7e79639-054f-4ee5-bb1d-4263f6efc170','resource_group':'rg-dio-project-01','workspace_name':'workspacedio','compute_target':'cpu-cluster','iterations':1000,'primary_metric':'normalized_root_mean_squared_error','task_type':'regression','IsImageTask':False,'IsTextDNNTask':False,'n_cross_validations':None,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':2,'iteration_timeout_minutes':15,'enforce_time_on_windows':False,'experiment_timeout_minutes':15,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':None,'blacklist_models':['ElasticNet','GradientBoosting','DecisionTree','KNN','LassoLars','SGD','RandomForest','ExtremeRandomTrees','LightGBM'],'blacklist_algos':['ElasticNet','GradientBoosting','DecisionTree','KNN','LassoLars','SGD','RandomForest','ExtremeRandomTrees','LightGBM','TensorFlowDNN','TensorFlowLinearRegressor'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'minimize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':{'_blocked_transformers':None,'_column_purposes':{},'_transformer_params':{'Imputer':None},'_dataset_language':None},'vm_priority':'dedicated','label_column_name':'Entregas','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2,'vm_type':'Standard_DS11_v2','process_count_per_instance':0,'gpu_memory_gb':0.0} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','verbosity':20,'ensemble_iterations':15,'ensemble_download_models_timeout_sec':300,'is_timeseries':False,'compute_target':'cpu-cluster','subscription_id':'b7e79639-054f-4ee5-bb1d-4263f6efc170','time_column_name':None,'grain_column_names':None}\",\"ensemble_run_id\":\"kind_boot_pjs8dddpzs_20\",\"experiment_name\":\"Exp-automl-projeto-01\",\"workspace_name\":\"workspacedio\",\"subscription_id\":\"b7e79639-054f-4ee5-bb1d-4263f6efc170\",\"resource_group_name\":\"rg-dio-project-01\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/eastus/workspaces/e0d288d1-4dae-4507-bcf1-2b63016d5aef/data/delivre/versions/1\",\"ResolvedUri\":\"azureml://locations/eastus/workspaces/e0d288d1-4dae-4507-bcf1-2b63016d5aef/data/delivre/versions/1\",\"AssetId\":\"azureml://locations/eastus/workspaces/e0d288d1-4dae-4507-bcf1-2b63016d5aef/data/delivre/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
